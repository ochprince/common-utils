...
import com.colasoft.opensearch.commons.alerting.aggregation.bucketselectorext.BucketSelectorExtFilter.Companion.BUCKET_SELECTOR_COMPOSITE_AGG_FILTER
import com.colasoft.opensearch.commons.alerting.aggregation.bucketselectorext.BucketSelectorExtFilter.Companion.BUCKET_SELECTOR_FILTER
...
class BucketSelectorExtAggregationBuilder :
    ...
    private var gapPolicy = BucketHelpers.GapPolicy.SKIP
     ...
     */
    fun gapPolicy(gapPolicy: BucketHelpers.GapPolicy?): BucketSelectorExtAggregationBuilder {
    ...
    companion object {
        ...
        fun parse(reducerName: String, parser: XContentParser): BucketSelectorExtAggregationBuilder {
            ...
            var gapPolicy: BucketHelpers.GapPolicy? = null
